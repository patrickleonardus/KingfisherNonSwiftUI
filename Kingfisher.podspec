Pod::Spec.new do |s|
  ...
  s.authors            = { "Patrick Leonardus" => "patrickleonardus@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/patrickleonardus/KingfisherNonSwiftUI", :tag => s.version }
